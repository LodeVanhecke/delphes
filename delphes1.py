...
# Book histograms
histJetPT = ROOT.TH1F("histJetPT", "jet P_{T}", 100, 0.0, 100.0)
histMass = ROOT.TH1F("histMass", "M_{inv}(e_{1}, e_{2})", 100, 40.0, 140.0)
...
for entry in range(0, numberOfEntries):
  ...
  if branchElectron.GetEntries() > 1:
    ...
    print(((elec1.P4()) + (elec2.P4())).M())
    histMass.Fill(((elec1.P4()) + (elec2.P4())).M())

# Show resulting histograms
c1=ROOT.TCanvas('c1','Histogram Jet')
histJetPT.Draw()
c2=ROOT.TCanvas('c2','Histogram M')
histMass.Draw()
