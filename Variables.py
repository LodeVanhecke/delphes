...
histNEL = ROOT.TH1F("histNEL", "Number of events from L",6 , 0, 6)
histNES = ROOT.TH1F("histNES", "Number of events from S",6 , 0, 6)
histNEC = ROOT.TH1F("histNEC", "Number of events from C",6 , 0, 6)
histNEB = ROOT.TH1F("histNEB", "Number of events from B",6, 0, 6)
...
#histNCPionD = ROOT.TH1F("histNCPionD", "Number of charged pions in D jet", 22, 0, 22)
histNCPionL = ROOT.TH1F("histNCPionL", "Number of charged pions in L jet", 22, 0, 22)
histNCPionS = ROOT.TH1F("histNCPionS", "Number of charged pions in S jet", 22, 0, 22)
histNCPionC = ROOT.TH1F("histNCPionC", "Number of charged pions in C jet", 22, 0, 22)
histNCPionB = ROOT.TH1F("histNCPionB", "Number of charged pions in B jet", 22, 0, 22)
...
#histNNPionD = ROOT.TH1F("histNNPionD", "Number of neutral pions in D jet", 16, 0, 16)
histNNPionL = ROOT.TH1F("histNNPionL", "Number of neutral pions in L jet", 16, 0, 16)
histNNPionS = ROOT.TH1F("histNNPionS", "Number of neutral pions in S jet", 16, 0, 16)
histNNPionC = ROOT.TH1F("histNNPionC", "Number of neutral pions in C jet", 16, 0, 16)
histNNPionB = ROOT.TH1F("histNNPionB", "Number of neutral pions in B jet", 16, 0, 16)
...
for entry in range(0, numberOfEntries):
 ...
 if branchGenJet.GetEntries() > 0:
  ...
  #   histJetPTU.Fill(jet.PT)
    ...
    # Fill histogram with number of kaons and pions/ Charge of jet
