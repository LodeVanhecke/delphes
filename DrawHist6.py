...
def Cosmetic2(hist,xtitle,ytitle,error,norm,logx,logy,logz,filename):
  c = ROOT.TCanvas()
  c.Divide(2,1)
  ROOT.gStyle.SetOptStat(0)
  for i in range(len(hist)):
...
#Cosmetic3(histJetCKaon,'DeltaPhi of charged kaons in jet','DeltaTheta of charged kaons in jet',False,False,False,False,'histJetCKaon_'+sys.argv[1][:-5]+'.png')

#histJetNKaon = [file.Get('histJetNKaonL')]+[file.Get('histJetNKaonS')]
#Cosmetic3(histJetNKaon,'DeltaPhi of neutral kaons in jet','DeltaTheta of neutral kaons in jet',False,False,False,False,'histJetNKaon_'+sys.argv[1][:-5]+'.png')

histJetCPion = [file.Get('histJetCPionL')]+[file.Get('histJetCPionS')]
Cosmetic3(histJetCPion,'DeltaPhi of charged pions from neutral kaon','DeltaTheta of charged pions from neutral kaon',False,False,False,False,'histJetCPion_'+sys.argv[1][:-5]+'.png')

#histJetNPion = [file.Get('histJetNPionL')]+[file.Get('histJetNPionS')]
#Cosmetic3(histJetNPion,'DeltaPhi of neutral pions in jet','DeltaTheta of neutral pions in jet',False,False,False,False,'histJetNPion_'+sys.argv[1][:-5]+'.png')

#histJetElec = [file.Get('histJetElecL')]+[file.Get('histJetElecS')]
#Cosmetic3(histJetElec,'DeltaPhi of electrons\positrons in jet','DeltaTheta of electrons\positrons in jet',False,False,False,False,'histJetElec_'+sys.argv[1][:-5]+'.png')

#histJetMuon = [file.Get('histJetMuonL')]+[file.Get('histJetMuonS')]
#Cosmetic3(histJetMuon,'DeltaPhi of muons in jet','DeltaTheta of muons in jet',False,False,False,False,'histJetMuon_'+sys.argv[1][:-5]+'.png')

#histJetProt = [file.Get('histJetProtL')]+[file.Get('histJetProtS')]
#Cosmetic3(histJetProt,'DeltaPhi of protons in jet','DeltaTheta of protons in jet',False,False,False,False,'histJetProt_'+sys.argv[1][:-5]+'.png')
